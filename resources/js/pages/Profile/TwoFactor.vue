...
function pinComplete(value: string[]) {
    ...
    <SettingsLayout>
      <div class="space-y-6">
          ...
          <Dialog :open="showModal" @update:open="showModal = $event">
            ...
            <DialogContent class="sm:max-w-md">
              <DialogHeader class="flex items-center justify-center">
                <div
                  class="p-0.5 w-auto rounded-full border mb-3 border-stone-100 dark:border-stone-600 bg-white
                    dark:bg-stone-800 shadow-sm"
                >
                  <div
                    class="p-2.5 rounded-full border border-stone-200 dark:border-stone-600 overflow-hidden
                      bg-stone-100 dark:bg-stone-200 relative"
                  >
                    <div
                      class="flex items-stretch absolute inset-0 w-full h-full divide-x [&>div]:flex-1
                        divide-stone-200 dark:divide-stone-300 justify-around opacity-50"
                    >
                      <div v-for="i in 5" :key="i" />
                    </div>
                    <div
                      class="flex flex-col items-stretch absolute w-full h-full divide-y [&>div]:flex-1 inset-0
                        divide-stone-200 dark:divide-stone-300 justify-around opacity-50"
                    >
                      <div v-for="i in 5" :key="i" />
                    </div>
              ...
              <div class="relative w-auto items-center justify-center flex flex-col space-y-5">
                <template v-if="!verifyStep">
                  <div class="relative max-w-md mx-auto overflow-hidden flex items-center p-8 pt-0">
                    <div
                      class="border border-stone-200 dark:border-stone-700 rounded-lg relative overflow-hidden w-64
                        aspect-square mx-auto"
                    >
                      <div
                        v-if="!qrCodeSvg"
                        class="bg-white dark:bg-stone-700 animate-pulse flex items-center justify-center absolute
                          inset-0 w-full h-auto aspect-square z-10"
                      >
                  ...
                  <div class="flex items-center relative w-full justify-center">
                    <div class="w-full absolute inset-0 top-1/2 bg-stone-200 dark:bg-stone-600 h-px" />
                  ...
                  <div class="flex items-center justify-center w-full space-x-2">
                    <div class="w-full rounded-xl flex items-stretch border dark:border-stone-700 overflow-hidden">
                      ...
                      <template v-else>
                        ...
                        >
                        <button
                          class="block relative border-l border-stone-200 dark:border-stone-600 px-3
                            hover:bg-stone-100 dark:hover:bg-stone-600 h-auto"
                    ...
                    <div class="w-full py-2 flex flex-col items-center justify-center space-y-3">
                      ...
                      >
                        <PinInputInput
                          ...
                          :key="id"
                          :index="index"
                          class="w-10 h-10 bg-white rounded-lg text-center shadow-sm border text-green10
                            placeholder:text-mauve8 focus:shadow-[0_0_0_2px] focus:shadow-stone-800 outline-none"
                        />
                      </PinInputRoot>
        ...
        <div v-if="confirmed" class="flex flex-col space-y-5">
          ...
          <div>
            <div
              class="flex items-start p-4 bg-stone-50 dark:bg-stone-800 border border-stone-200
                dark:border-stone-700 rounded-t-xl"
            >
            ...
            <div
              class="bg-stone-100 dark:bg-stone-800 rounded-b-xl border-t-0 border border-stone-200
                dark:border-stone-700 text-sm"
            >
              <div
              ...
              >
                <div
                  class="grid max-w-xl gap-1 px-4 py-4 font-mono text-sm bg-stone-200 dark:bg-stone-900
                    dark:text-stone-100"
                >
                  <div v-for="(code, index) in recoveryCodesList" :key="index">
                    {{ code }}
                  </div>
                </div>
